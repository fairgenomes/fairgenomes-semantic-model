...
The FAIR Genomes semantic metadata schema to power reuse of NGS data in research and healthcare. Version 0.4-SNAPSHOT, 2021-04-23. This model consists of 9 modules that contain 109 metadata elements and 84910 lookups in total (excluding null flavors).
...
\hline
\end{tabular}
\caption[Module overview]{\label{table:table1} FAIR Genomes v0.4-SNAPSHOT overview of all modules.}
\end{table}
