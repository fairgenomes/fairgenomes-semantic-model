...
Collection & DCAT:Collection & String \\
Research Consortia & NCIT:C61538 & String \\
\hline
\end{tabular}
\caption[Module: HMD Submission]{\label{table:table11} Module: HMD Submission. Items specific to use in the 1+MG GDI project for metadata submission. Ontology: AFRL:0000449. }
\end{table}
