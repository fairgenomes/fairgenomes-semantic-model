...
The FAIR Genomes semantic metadata schema to power reuse of NGS data in research and healthcare. Version 1.2-SNAPSHOT, 2021-07-20. This model consists of 9 modules that contain 112 metadata elements and 85351 lookups in total (excluding null flavors).
...
\hline
\end{tabular}
\caption[Module overview]{\label{table:table1} FAIR Genomes metadata schema v1.2-SNAPSHOT overview of all modules.}
\end{table}
