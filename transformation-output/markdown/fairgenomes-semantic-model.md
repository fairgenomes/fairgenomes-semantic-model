...
|---|---|---|---|
| [Study](#module-study) | A detailed examination, analysis, or critical inspection of a subject designed to discover facts about it. | [NCIT:C63536](http://purl.obolibrary.org/obo/NCIT_C63536) | 6 |
...
| [Informed consent form](#module-informed-consent-form) | A document explaining all the relevant information to assist an individual in understanding the expectations and risks in making a decision about a procedure. This document is presented to and signed by the individual or guardian. | [NCIT:C16468](http://purl.obolibrary.org/obo/NCIT_C16468) | 9 |
| [Individual consent](#module-individual-consent) | Consent by a patient to a surgical or medical procedure or participation in a clinical study after achieving an understanding of the relevant medical facts and the risks involved. | [NCIT:C16735](http://purl.obolibrary.org/obo/NCIT_C16735) | 15 |
| [Clinical](#module-clinical) | Data obtained through patient examination or treatment. | [NCIT:C15783](http://purl.obolibrary.org/obo/NCIT_C15783) | 19 |
| [Material](#module-material) | Natural substances derived from living organisms such as cells, tissues, proteins, and DNA. | [NCIT:C43376](http://purl.obolibrary.org/obo/NCIT_C43376) | 14 |
...
| About subject | The person (subject) whom this individual consent applies. | [IAO:0000136](http://purl.obolibrary.org/obo/IAO_0000136) | Reference to instances of Personal |
| Consent form used | The informed consent form that was signed. | [IAO:0000136](http://purl.obolibrary.org/obo/IAO_0000136) | Reference to instances of Informed consent form |
...
| Belongs to material | Link to the material from which this sample was prepared. | [NCIT:C25683](http://purl.obolibrary.org/obo/NCIT_C25683) | Reference to instances of Material |
...
| Belongs to sample | Link to the prepared sample that was sequenced. | [NCIT:C25683](http://purl.obolibrary.org/obo/NCIT_C25683) | Reference to instances of Sample preparation |
...
| Belongs to sequencing | Link to the sequencing performed on which the analysis is based. | [NCIT:C25683](http://purl.obolibrary.org/obo/NCIT_C25683) | Reference to instances of Sequencing |
