...
mcmd import -p personal_gender_attributes.tsv --as attributes --in fair-genomes
...
mcmd import -p clinical_clinicaldiagnosis_attributes.tsv --as attributes --in fair-genomes
mcmd import -p clinical_moleculardiagnosisgene_attributes.tsv --as attributes --in fair-genomes
mcmd import -p clinical_medication_attributes.tsv --as attributes --in fair-genomes
...
mcmd import -p personal_gender.tsv --as fair-genomes_personal_gender --in fair-genomes
...
mcmd import -p clinical_clinicaldiagnosis.tsv --as fair-genomes_clinical_clinicaldiagnosis --in fair-genomes
mcmd import -p clinical_moleculardiagnosisgene.tsv --as fair-genomes_clinical_moleculardiagnosisgene --in fair-genomes
mcmd import -p clinical_medication.tsv --as fair-genomes_clinical_medication --in fair-genomes
...
mcmd add logo -p ../../misc/molgenis/img/fair_genomes_logo.png
